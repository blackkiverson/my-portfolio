...
const info = [
 {
  icon: <FaPhoneAlt />,
  title: 'Phone',
  description: '(+63) 976 555 5622',
 },
 {
  icon: <FaEnvelope />,
  title: 'Email',
  description: 'samuelonyebuchi170@gmail.com',
 },
 {
  icon: <FaMapMarkerAlt />,
  title: 'Address',
     ...
     <div className="xl:w-[54%] order-2 xl:order-none">
      ...
      >
       ...
       <p className="text-3xl">
        I'm excited to work together on something special. Whether you’re
        interested in collaborating or just have a question, feel free to reach
